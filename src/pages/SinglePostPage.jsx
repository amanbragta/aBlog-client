            ...
            <div className="p-4 h-full sticky top-8">
                <h2 className="mb-4 text-sm font-medium">Author</h2>
                    <div className="flex flex-col gap-4">
                        ...
                        {data?.user?.img && <img src={data.user.img} className='w-20 rounded-full'/>}
                        
                        <Link>{data?.user?.username}</Link>
                        </div>
                        <p className="text-sm text-gray-500">The description of user goes here</p>
                        <div className="flex gap-2">
                            ...
                            <Link><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-blue-500" viewBox="0 0 16 16">
                    ...
                    <div className="flex flex-col gap-2 text-sm">
                        ...
                        <Link className="underline">Technology</Link>
                        <Link className="underline">Nature</Link>
                        <Link className="underline">Art</Link>
                        <Link className="underline">Design</Link>
                    </div>
